...
public class AdventureCoreModel extends FizzleableModel<AdventureCoreEntity> {
    public static final ModelLayerLocation ADVENTURE_CORE_LAYER = new ModelLayerLocation(id("adventure_core"), "main");
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        bb_main.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(24, 3).addBox(-1.5F, -1.5F, 0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 3.425F, 0.0F, 3.1416F, 0.0F));
