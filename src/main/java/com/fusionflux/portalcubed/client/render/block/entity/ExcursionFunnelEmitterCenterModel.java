...
public class ExcursionFunnelEmitterCenterModel extends Model {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = you_spin_me_right_round.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.75F, 0.0F, -3.5F, 8.0F, 0.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -3.1416F, 0.0F));
		...
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(5, 18).addBox(-2.5F, -1.0F, -2.5F, 5.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(10, 18).addBox(-2.5F, -1.0F, -2.5F, 5.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.7875F, 0.0125F, 0.0F, 0.7854F, 0.0F));
