...
public class StorageCubeRenderer extends MobEntityRenderer<StorageCubeEntity, StorageCubeModel> {
    ...
    private static final Identifier TEXTURE = new Identifier(PortalCubed.MOD_ID, "textures/entity/storage_cube.png");
    private static final Identifier ACTIVE_TEXTURE = new Identifier(PortalCubed.MOD_ID, "textures/entity/storage_cube_lit.png");
    ...
    public StorageCubeRenderer(EntityRendererFactory.Context context) {
        ...
        this.addFeature(new EmissiveFeatureRenderer<>(this) {
            ...
            private static final Identifier EMISSIVE_TEXTURE = new Identifier(PortalCubed.MOD_ID, "textures/entity/storage_cube_e.png");
            private static final Identifier EMISSIVE_ACTIVE_TEXTURE = new Identifier(PortalCubed.MOD_ID, "textures/entity/storage_cube_lit_e.png");
