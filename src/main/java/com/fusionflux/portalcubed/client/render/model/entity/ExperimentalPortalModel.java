...
public class ExperimentalPortalModel extends EntityModel<ExperimentalPortal> {
    ...
    public static ModelData getModelData(){
        ...
        modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(0, 0).cuboid(-0.0F, -0.0F, -0.0F, 0.0F, 0.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
        return modelData;
    }
