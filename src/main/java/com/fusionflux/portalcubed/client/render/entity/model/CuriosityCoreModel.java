...
public class CuriosityCoreModel extends FizzleableModel<CuriosityCoreEntity> {
	public static final ModelLayerLocation CURIOSITY_CORE_LAYER = new ModelLayerLocation(id("curiosity_core"), "main");
	...
	public static LayerDefinition getTexturedModelData() {
		...
		bb_main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(7, 26).addBox(4.0159F, -2.5F, -1.816F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(7, 26).addBox(-1.741F, -2.5F, 4.0909F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.9421F, 2.3687F, 0.0F, -0.7854F, 1.5708F));

		bb_main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(24, 0).addBox(-1.5F, -1.5579F, -0.4437F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.9421F, 2.3687F, 0.0F, 3.1416F, 0.0F));
