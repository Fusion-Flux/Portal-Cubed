...
public class AngerCoreModel extends FizzleableModel<AngerCoreEntity> {
	public static final ModelLayerLocation ANGER_CORE_LAYER = new ModelLayerLocation(id("anger_core"), "main");
	...
	public static LayerDefinition getTexturedModelData() {
		...
		bb_main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(11, 26).addBox(-2.4F, -3.0F, 3.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 5.0F, 3.5F, 0.0F, -0.7854F, 1.5708F));

		bb_main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(11, 26).addBox(-2.5F, -3.0F, 3.25F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -3.0F, 3.5F, 0.0F, -0.7854F, 1.5708F));

		bb_main.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(24, 3).addBox(-1.5F, -1.5F, 0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 3.425F, 0.0F, 3.1416F, 0.0F));
