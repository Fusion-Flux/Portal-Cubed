...
public class CoreFrameModel extends FizzleableModel<CoreFrameEntity> {
	public static final ModelLayerLocation CORE_FRAME_LAYER = new ModelLayerLocation(id("core_frame"), "main");
	...
	public static LayerDefinition getTexturedModelData() {
		...
		bb_main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(24, 6).addBox(-1.5F, -1.5F, 0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 3.175F, 0.0F, 3.1416F, 0.0F));

		bb_main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 12).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.2F))
