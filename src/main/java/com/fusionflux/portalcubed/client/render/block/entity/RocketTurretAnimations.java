...
public class RocketTurretAnimations {
    ...
    public static final Animation SHOOT = Animation.Builder.withLength(1.5f)
        .addPartAnimation(
            "green",
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                ...
                new AnimationKeyframe(0.15f, Animator.translate(0f, 0f, 0f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(0.16f, Animator.translate(0f, 0.028248124719086058f, 0.9245685715239597f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(1.43f, Animator.translate(0f, 0.028248124719086058f, 0.9245685715239597f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(1.44f, Animator.translate(0f, 0f, 0f),
                                      PartAnimation.Interpolators.LINEAR
                )
            )
        )
        .addPartAnimation(
            ...
            new PartAnimation(
                ...
                new AnimationKeyframe(0.16f, Animator.translate(0f, -0.002290388490736707f, -0.07496501931275346f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(0.97f, Animator.translate(0f, -0.002290388490736707f, -0.07496501931275346f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(0.98f, Animator.translate(0f, 0.03053851320982276f, 0.9295335908367128f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(1.44f, Animator.translate(0f, 0f, 0f),
                                      PartAnimation.Interpolators.LINEAR
        ...
        .addPartAnimation(
            ...
            new PartAnimation(
                PartAnimation.AnimationTargets.TRANSLATE,
                new AnimationKeyframe(0.97f, Animator.translate(0f, 0f, 0f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(0.98f, Animator.translate(0f, -0.00916155396294683f, -0.2998600772510138f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(1.43f, Animator.translate(0f, -0.00916155396294683f, -0.2998600772510138f),
                                      PartAnimation.Interpolators.LINEAR
                ),
                new AnimationKeyframe(1.44f, Animator.translate(0f, 0f, 0f),
                                      PartAnimation.Interpolators.LINEAR
