...
public class FactCoreModel extends FizzleableModel<FactCoreEntity> {
	public static final ModelLayerLocation FACT_CORE_LAYER = new ModelLayerLocation(id("fact_core"), "main");
	...
	public static LayerDefinition getTexturedModelData() {
		...
		bb_main.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(24, 6).addBox(-1.5F, -1.5F, 0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 3.425F, 0.0F, 3.1416F, 0.0F));
