...
public class PortalCubedBlocks {
    ...
    public static final ExcursionFunnelTubeBlock EXCURSION_FUNNEL = new ExcursionFunnelTubeBlock(QuiltBlockSettings.of(Material.AIR).noOcclusion().noCollission());
