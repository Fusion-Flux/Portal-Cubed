...
import com.fusionflux.portalcubed.blocks.blockentities.LaserCatcherBlockEntity;
...
public class LaserCatcherBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, PortalCubedBlocks.LASER_CATCHER_ENTITY, LaserCatcherBlockEntity::tick1);
    }
