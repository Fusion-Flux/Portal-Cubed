...
public class PortalGun extends Item implements DyeableItem {
    ...
    public static void linkPortals(ExperimentalPortal portal1, ExperimentalPortal portal2, float volume) {
        portal1.setDestination(portal2.getOriginPos().add(portal2.getFacingDirection().getUnitVector().getX()*.1,portal2.getFacingDirection().getUnitVector().getY()*.1,portal2.getFacingDirection().getUnitVector().getZ()*.1));
        ...
        portal2.setDestination(portal1.getOriginPos().add(portal1.getFacingDirection().getUnitVector().getX()*.1,portal1.getFacingDirection().getUnitVector().getY()*.1,portal1.getFacingDirection().getUnitVector().getZ()*.1));
