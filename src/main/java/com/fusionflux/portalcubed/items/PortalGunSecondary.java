...
public class PortalGunSecondary extends Item implements DyeableItem {
    ...
    public int getColor(ItemStack stack) {
        ...
        return compoundTag != null && compoundTag.contains("color", 99) ? compoundTag.getInt("color") * -1 : 14842149;
    }
