...
public class PortalCubedItems {
    ...
    //public static final GelOrb GEL_ORB = new GelOrb(new QuiltItemSettings().group(PortalCubed.PortalCubedGroup).maxCount(64));
    ...
    public static final PortalGun PORTAL_GUN = new PortalGun(new QuiltItemSettings().group(PortalCubed.PortalCubedGroup).maxCount(1).fireproof());
    public static final Item PORTAL_GUN_FRAME = new Item(new QuiltItemSettings().group(PortalCubed.PortalCubedGroup).maxCount(1).fireproof());
    public static final Item PORTAL_GUN_CASING = new Item(new QuiltItemSettings().group(PortalCubed.PortalCubedGroup).maxCount(1).fireproof());
    public static final Item MINI_BLACKHOLE = new Item(new QuiltItemSettings().group(PortalCubed.PortalCubedGroup).maxCount(1).fireproof());
