                ...
                if(!((CubeEntity) element).world.isClient) {
                    if (impulse >= .15 && impulse <= .5) {
                        if (Math.abs(this.age - this.storedAge) > 2) {
                            ((CubeEntity) element).world.playSound(null, ((CubeEntity) element).getPos().getX(), ((CubeEntity) element).getPos().getY(), ((CubeEntity) element).getPos().getZ(), ThinkingWithPortatosSounds.CUBE_LOW_HIT_EVENT, SoundCategory.NEUTRAL, .25f, 1F);
                    ...
                    if (impulse >= .5) {
                        if (Math.abs(this.age - this.storedAge) > 2) {
                            ((CubeEntity) element).world.playSound(null, ((CubeEntity) element).getPos().getX(), ((CubeEntity) element).getPos().getY(), ((CubeEntity) element).getPos().getZ(), ThinkingWithPortatosSounds.CUBE_HIGH_HIT_EVENT, SoundCategory.NEUTRAL, .25f, 1F);
