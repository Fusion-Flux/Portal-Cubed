...
public class CubeEntityRenderer extends EntityRenderer<CubeEntity> {
    private static final Identifier BASE_TEXTURE = new Identifier(ThinkingWithPortatos.MOD_ID, "textures/entity/cube.png");
    private static final Identifier COMPANION_TEXTURE = new Identifier(ThinkingWithPortatos.MOD_ID, "textures/entity/companion_cube.png");
