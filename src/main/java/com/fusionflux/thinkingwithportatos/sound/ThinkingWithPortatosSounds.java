...
public class ThinkingWithPortatosSounds {
    ...
    public static SoundEvent PORTAL_AMBIANT_EVENT = new SoundEvent(PORTAL_AMBIANCE);
    ...
    public static SoundEvent INVALID_PORTAL_EVENT = new SoundEvent(PORTAL_INVALID_SURFACE);
    public static SoundEvent ENTITY_ENTER_PORTAL = new SoundEvent(PORTAL_ENTER);
    public static SoundEvent ENTITY_EXIT_PORTAL = new SoundEvent(PORTAL_EXIT);
    public static SoundEvent ENTITY_PORTAL_OPEN = new SoundEvent(PORTAL_OPEN);
    public static SoundEvent ENTITY_PORTAL_CLOSE = new SoundEvent(PORTAL_CLOSE);
    public static SoundEvent CUBE_HIT_EVENT = new SoundEvent(CUBE_HIT);
    public static SoundEvent COMPANION_CUBE_AMBIANCE_EVENT = new SoundEvent(COMPANION_CUBE_AMBIANCE);
