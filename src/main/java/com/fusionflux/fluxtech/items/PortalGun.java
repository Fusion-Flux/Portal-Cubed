...
public class PortalGun extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (blockPos != null && blockPos2 != null) {
            ...
            assert portal != null;
            portal.setOriginPos(new Vec3d(blockPos.getX() + .5 + (direction1.x / 1.96), blockPos.getY(), blockPos.getZ() + .5 + (direction1.z / 1.96)));
            portal.setDestinationDimension(World.OVERWORLD);
            portal.setOrientationAndSize(
                    new Vec3d(direction1.z, direction1.y, -direction1.x), //axisW
            ...
            assert portal2 != null;
            portal2.setOriginPos(new Vec3d(blockPos2.getX() + .5 + (direction2.x / 1.96), blockPos2.getY(), blockPos2.getZ() + .5 + (direction2.z / 1.96)));
            portal2.setDestinationDimension(World.OVERWORLD);
            portal2.setOrientationAndSize(
                    new Vec3d(direction2.z, direction2.y, -direction2.x),//axisW
                    new Vec3d(0, 1, 0),//axisH
                    1,//width
                    2//height
            );
